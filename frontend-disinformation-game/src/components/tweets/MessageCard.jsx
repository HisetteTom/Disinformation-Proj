...
function MessageCard({ message, onModerate, hideApproveButton, hideButtons, clickable, onClose, onClick, isExpanded }) {
  ...
  return (
    <div className={`rounded-lg border border-blue-200 bg-gradient-to-br from-blue-50 to-white p-4 shadow-sm transition-all duration-300 ${clickable ? "cursor-pointer hover:bg-blue-50 hover:shadow-md" : ""} ${isExpanded ? "border-blue-300 shadow-lg" : ""}`} onClick={onClick ? onClick : undefined}>
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <div className="text-xs text-blue-500">
              <svg xmlns="http://www.w3.org/2000/svg" className="mr-1 inline-block h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {mediaFilesArray.length > 0 && <div className="mt-2 grid grid-cols-2 gap-2 overflow-hidden rounded-lg border border-blue-100">{mediaFilesArray.map((media, index) => renderMediaItem(media, index))}</div>}

      <div className="mt-3 flex gap-4 border-t border-gray-100 pt-3 text-sm text-gray-600">
        <span className="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="mr-1 h-4 w-4 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
          </svg>
          {message.likes || 0}
        </span>
        <span className="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="mr-1 h-4 w-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-3 flex flex-wrap gap-2 border-t border-gray-100 pt-2">
          {!hideApproveButton && (
            <button
              ...
              className="flex items-center rounded bg-green-600 px-3 py-1 text-white transition hover:bg-green-700"
            >
          ...
          <button
            ...
            className="flex items-center rounded bg-red-600 px-3 py-1 text-white transition hover:bg-red-700"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="mr-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button
            ...
            className="flex items-center rounded bg-blue-600 px-3 py-1 text-white transition hover:bg-blue-700"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="mr-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
